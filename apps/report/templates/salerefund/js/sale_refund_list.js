...
$import(['public/js/select2/select2.min.js',"public/js/bootstrap-datepicker/js/bootstrap-datepicker.js","public/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"],function(){
	util.setItem('orl','index.php?mod=report&con=SaleRefund&act=search');//设定刷新的初始url
	util.setItem('formID','sale_refund_search_form');//设定搜索表单id
	util.setItem('listDIV','sale_refund_search_list');//设定列表数据容器id
    var info_form_id = 'sale_refund_search_form';//form表单id
	//匿名函数+闭包
	var obj = function(){
