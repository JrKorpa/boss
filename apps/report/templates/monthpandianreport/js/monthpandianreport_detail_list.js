...
$import(['public/js/select2/select2.min.js','public/js/bootstrap-datepicker/js/bootstrap-datepicker.js','public/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js'], function(){
	util.setItem('orl','index.php?mod=report&con=MonthPandianReport&act=detail_list_ajax&id='+id);//设定刷新的初始url
	util.setItem('formID','monthpandianreport_detail_search_form');//设定搜索表单id
	util.setItem('listDIV','monthpandianreport_detail_search_list');//设定列表数据容器id
