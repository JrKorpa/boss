$import(["public/js/select2/select2.min.js"],function(){
	var info_form_id = 'sale_plan_two_info';//form表单id
	var info_form_base_url = 'index.php?mod=report&con=SalePlanTwo&act=';//基本提交路径
	var info_id= '';
...
//			});	
		...
		var handleForm = function(){
			var month="<%$method%>";		
			var url = info_form_base_url+$.trim(month);
			var options1 = {
				url: url,
				error:function ()
				{
					...
					if(data.success == 1 ){
						...
						util.xalert(
							...
							function(){
								...
								//window.location.href="/index.php?mod=report&con=SalePlan&act=index";
							}
						);
					}
					else
