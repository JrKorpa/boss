...
$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js",
	...
	util.setItem('orl','index.php?mod=report&con=ShopcountReport&act=showgwreport');
	...
	var ShopCfgObj = function(){
		var initElements=function(){
            $('#shopcount_search_xsgw_form select[name="shop_id"]').select2({
                placeholder: "请选择",
                allowClear: true
            }).change(function(e){
                $(this).valid();
...
//导出
function download(){
	var args=$("#shopcount_search_xsgw_form").serialize();
    location.href = "index.php?mod=report&con=ShopcountReport&act=showgwreport&sel_excel=excel&"+args;
