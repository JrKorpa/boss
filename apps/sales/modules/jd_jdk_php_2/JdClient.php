...
class JdClient
{
	...
	public function __construct($appKey,  $appSecret, $accessToken , $is_sandbox = false)
    {
        if($is_sandbox)
        {
            $this->serverUrl = 'http://gw.api.sandbox.360buy.com/routerjson';
        }
        else
        {
            $this->serverUrl = 'http://gw.api.360buy.com/routerjson';
        }
        $this->appKey = $appKey;
