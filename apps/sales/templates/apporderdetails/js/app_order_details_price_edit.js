...
function order_detil_kezi_out_goods_edit() {
	...
	$('#app_order_details_price_edit').html(AnalyticEmotion(inputText));
}

$import(['public/js/jquery.sinaEmotion.css','public/js/jquery.sinaEmotion.js','public/js/select2/select2.min.js'],function(){
	var info_form_id = 'app_order_details_price_edit';//form表单id
	...
	var obj = function(){
		var initElements = function(){
			...
			$('#app_order_details_price_edit').SinaEmotion($('.emotion'));
		};
		
		//表单验证和提交
		var handleForm = function(){
			var url = info_form_base_url+'updateOrderDetailsPrice';
			var options1 = {
				url: url,
				error:function ()
				{
