$import("public/js/select2/select2.min.js",function(){
	...
	var obj = function(){
		var initElements = function(){
            $('#update_order_dinggou_info select[name="dinggou"]').select2({
                placeholder: "请选择",
                allowClear: true
            }).change(function(e) {
                $(this).valid();
		...
		var handleForm1 = function(){
            var info_form_id1 = 'update_order_dinggou_info';
			var url = 'index.php?mod=sales&con=UpdateOrderDingGou&act=update_dinggou';
			var options1 = {
				url: url,
				error:function ()
				{
