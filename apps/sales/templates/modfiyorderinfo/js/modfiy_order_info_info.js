$import("public/js/select2/select2.min.js",function(){
	var info_form_id = 'modfiy_order_info_info';//form表单id
	var info_form_base_url = 'index.php?mod=sales&con=ModfiyOrderInfo&act=';//基本提交路径
	...
	var obj = function(){
		...
		var handleForm = function(){
			var url = info_form_base_url+'batch_update';
			var options1 = {
				url: url,
				error:function ()
				{
