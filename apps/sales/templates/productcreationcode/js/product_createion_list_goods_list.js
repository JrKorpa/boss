//分页
function product_creation_code_search_page(url){
	util.page(url);
}
...
$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js","public/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js","public/js/select2/select2.min.js"],function(){
	util.setItem('orl','index.php?mod=sales&con=ProductCreationCode&act=search');//设定刷新的初始url
	...
	var obj = function(){
		...
		var initData = function(){
			...
			product_creation_code_search_page(util.getItem("orl"));
		}
		return {
			init:function(){
