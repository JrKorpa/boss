$import("public/js/select2/select2.min.js",function(){
	...
	var obj = function(){
		var initElements = function(){
			$('#order_info_modfiy_info_from_ad select').select2({
                placeholder: "请选择",
                allowClear: true
            }).change(function(e) {
                $(this).valid();
		...
		$('#order_info_modfiy_info_from_ad :reset').on('click',function(){
				$('#order_info_modfiy_info_from_ad select').select2("val","");
			})
		};
		//表单验证和提交
		var handleForm1 = function(){
            var info_form_id1 = 'order_info_modfiy_info_from_ad';

			var url = 'index.php?mod=sales&con=UpdateOrderFromad&act=update';
			var options1 = {
				url: url,
				error:function ()
				{
