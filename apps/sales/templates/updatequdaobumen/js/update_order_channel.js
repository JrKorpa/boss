$import("public/js/select2/select2.min.js",function(){
	...
	var obj = function(){
		var initElements = function(){
            $('#update_order_channel select[name="channel"]').select2({
                placeholder: "请选择",
                allowClear: true
            }).change(function(e) {
                $(this).valid();
		...
		var handleForm1 = function(){
            var info_form_id1 = 'update_order_channel';
			var url = 'index.php?mod=sales&con=UpdateQudaoBumen&act=update_channel';
			var options1 = {
				url: url,
				error:function ()
				{
