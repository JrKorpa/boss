$import(function(){
    var info_form_id = 'external_pay';//form表单id
    var info_form_base_url = 'index.php?mod=sales&con=ExternalOrderPay&act=';
    var obj = function(){
