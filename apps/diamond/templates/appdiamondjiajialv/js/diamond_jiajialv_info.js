$import(['public/js/select2/select2.min.js','public/js/jquery.validate.extends.js'],function(){
	...
	var obj = function(){
		...
		var handleForm = function(){
			console.log(info_id);
			var url = info_id ? 'index.php?mod=diamond&con=AppDiamondJiajialv&act=update' : 'index.php?mod=diamond&con=AppDiamondJiajialv&act=insert';
//			var url = 'index.php?mod=diamond&con=AppDiamondJiajialv&act=insert';		//添加做插入处理
			var options1 = {
				url: url,
				error:function ()
				{
