...
//匿名回调
$import(function(){
	util.setItem('orl','index.php?mod=diamond&con=DiamondColorKaiGuan&act=search');//设定刷新的初始url
	...
	var obj = function(){
		...
		var initElements = function(){
			$('button[type="button"]').on('click',function(){
				...
				$.post('index.php?mod=diamond&con=DiamondColorKaiGuan&act=update_kai',data,function(data){
