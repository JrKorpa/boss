...
$import(["public/js/select2/select2.min.js", 'public/js/jquery.validate.extends.js'],function(){
	...
	var obj1 = function(){
        ...
        var handleForm = function() {
            var url = 'index.php?mod=diamond&con=DiamondGetJxc&act=upload_ins';
            var options1 = {
                url: url,
                error: function()
                {
		...
		var initData = function(){
			$("button:button[val=1]").on('click', function(){
				...
				location.href = "index.php?mod=diamond&con=DiamondGetJxc&act=downLoad&id="+xianhuoway;
			});
		}
		return {
			init:function(){
...
{
	document.location.href='index.php?mod=diamond&con=DiamondInfo&act=dow';
}
