 ...
 *  -------------------------------------------------
 */
class DiamondColorKaiGuanController extends CommonController
{
...
// 		Util::V('app_shop_config',17);	//生成视图后请注释该行
	...
	public function search ($params)
	{
		...
		$model = new DiamondColorKaiGuanModel(18);
		$kaiguanList = $model->getAllList();
		$pageData['filter'] = $args;
		$pageData['jsFuncs'] = 'diamond_color_kai_guan_search_page';
	...
	public function update_kai ($params)
	{
		...
		$newmodel =  new  DiamondColorKaiGuanModel(17);
