$import(['public/js/select2/select2.min.js','public/js/bootstrap-datepicker/js/bootstrap-datepicker.js','public/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js'], function(){
	var info_form_id = 'adjustment_price';//form表单id
	var info_form_base_url = 'index.php?mod=buydia&con=DiaBillSearch&act=';//基本提交路径
...
//				minimumInputLength: 2
		...
		var handleForm = function(){
			var url = info_form_base_url+(info_id ? 'update' : 'insertadjustmentPrice');
			var options1 = {
				url: url,
				error:function ()
				{
