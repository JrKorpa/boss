$import(function(){
	var info_form_id = 'dia_info';//form表单id
	var info_form_base_url = 'index.php?mod=buydia&con=DiaQuery&act=';//基本提交路径
...
//			});	
		...
		var handleForm = function(){
			var url = info_form_base_url+(info_id ? 'loseEfficacyExecute' : 'insert');
			var options1 = {
				url: url,
				error:function ()
				{
