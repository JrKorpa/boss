$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js",
	...
	var info_form_id = 'base_hunbohui_info_info';//form表单id
	var info_form_base_url = 'index.php?mod=management&con=BaseHunbohuiInfo&act=';//基本提交路径
	var info_id= '<%$view->get_id()%>';

	var obj = function(){
		var initElements = function(){

            $('#base_hunbohui_info_info select').select2({
                placeholder: "请选择",
                allowClear: true
            }).change(function(e) {
                $(this).valid();
			...
			$('#base_hunbohui_info_info select[name="from_ad"]').change(function(){
				$('#base_hunbohui_info_info input[name="from_adHtml"]').val($(this).find("option:selected").text());
			})
		};
						...
						util.xalert(
							...
							function(){
								...
								else
								{
									...
									{//刷新首页
										base_hunbohui_info_search_page(util.getItem("orl"));
									}
								}
							}
						);
