$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js", "public/js/select2/select2.min.js"], function(){
	var info_form_id = 'app_receive_should_info';//form表单id
	var info_form_base_url = 'index.php?mod=finance&con=AppReceiveShould&act=';//基本提交路径
	var info_id= '<%$view->get_should_id()%>';

	var obj = function(){
		var initElements = function(){
            $('#app_receive_should_info select[name="bank_name"]').select2({
                placeholder: "请选择",
                allowClear: true,
            }).change(function(e) {
                $(this).valid();
