 ...
 *  -------------------------------------------------
 */
class ProcessorOutAccountModel extends Model {
	...
	*/
	public function updateRealValue($id,$arr){
        ...
        public  function GetProcessorInfo($args){
           ...
           // }
                $bill_type_info = $args['bill_type_info'];
           // if (!empty($args['pro_id'])) {
                $pro_id = $args['pro_id'];
            //}
            //if (!empty($args['fin_status'])) {
                $fin_status = $args['fin_status'];
           // }
            //if (!empty($args['account_type'])) {
                //$account_type = $args['account_type'];
           // }
           // if (!empty($args['pay_channel'])) {
                $pay_channel = $args['pay_channel'];
           // }
           // if (!empty($args['make_time_start'])) {
                $make_time_s = $args['make_time_start'];
           // }
           // if (!empty($args['make_time_end'])) {
                $make_time_e = $args['make_time_end'];
           // }
           // if (!empty($args['check_time_start'])) {
                $check_time_s = $args['check_time_start'];
           // }
           // if (!empty($args['check_time_end'])) {
                $check_time_e = $args['check_time_end'];
           // }
           // if (!empty($args['fin_check_time_start'])) {
                $fin_check_time_s = $args['fin_check_time_start'];
           // }
           // if (!empty($args['fin_check_time_end'])) {
                $fin_check_time_e = $args['fin_check_time_end'];
           // }
                $page = $args['page'];
