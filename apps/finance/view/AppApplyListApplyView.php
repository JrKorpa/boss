...
/**
 *  -------------------------------------------------
 *   @file		: AppApplyListApplyView.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class AppApplyListApplyView extends View
{
	protected $_apply_id;
...
//获取结算商列表
	...
	{
		$applyGoods = new AppAdjApplyModel(29);
		$applyGoodsData = $applyGoods->getDataOfApplyId($this->_apply_id);
		return $applyGoodsData;
	}
}
?>