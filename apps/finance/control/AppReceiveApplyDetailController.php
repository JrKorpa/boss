...
/**
 *  -------------------------------------------------
 *   @file		: AppReceiveApplyDetailController.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class AppReceiveApplyDetailController extends CommonController
{
	...
	{
		$this->render('app_receive_apply_detail_search_form.html',array('bar'=>Auth::getBar()));
	}
	...
	public function search ($params)
	{
		...
		$model = new AppReceiveApplyDetailModel(29);
		$data = $model->pageList($where,$page,10,false);
		$pageData = $data;
		$pageData['filter'] = $args;
		$pageData['jsFuncs'] = 'app_receive_apply_detail_search_page';
		$this->render('app_receive_apply_detail_search_list.html',array(
	...
	public function add ()
	{
		...
		$result['content'] = $this->fetch('app_receive_apply_detail_info.html',array(
			'view'=>new AppReceiveApplyDetailView(new AppReceiveApplyDetailModel(29))
		));
		$result['title'] = '添加';
	...
	public function edit ($params)
	{
		...
		$result = array('success' => 0,'error' => '');
		$result['content'] = $this->fetch('app_receive_apply_detail_info.html',array(
			'view'=>new AppReceiveApplyDetailView(new AppReceiveApplyDetailModel($id,29)),
			'tab_id'=>$tab_id
		));
		$result['title'] = '编辑';
		Util::jsonExit($result);
	...
	{
		$id = intval($params["id"]);
		$this->render('app_receive_apply_detail_show.html',array(
			'view'=>new AppReceiveApplyDetailView(new AppReceiveApplyDetailModel($id,29)),
			'bar'=>Auth::getViewBar()
		));
	}
	...
	public function insert ($params)
	{
		...
		$newmodel =  new AppReceiveApplyDetailModel(30);
	...
	public function update ($params)
	{
		...
		$newmodel =  new AppReceiveApplyDetailModel($id,30);
	...
	public function delete ($params)
	{
		$result = array('success' => 0,'error' => '');
		$id = intval($params['id']);
		$model = new AppReceiveApplyDetailModel($id,30);
