...
/**
 *  -------------------------------------------------
 *   @file		: AppAdjApplyController.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class AppAdjApplyController extends CommonController
{
	...
	{
		$this->render('app_adj_apply_search_form.html',array('bar'=>Auth::getBar(),'company'=>self::$company,'applyOrderDoStatus'=>self::$applyOrderDoStatus,'view'=>new AppApplyListApplyView(new AppApplyListApplyModel(29)),'payType'=>self::$payType));
	}
	...
	public function search ($params)
	{
		...
		$pageData['jsFuncs'] = 'app_adj_apply_search_page';
		$this->render('app_adj_apply_search_list.html',array(
	...
	public function add ()
	{
		...
		$result['content'] = $this->fetch('app_adj_apply_info.html',array(
			'view'=>new AppAdjApplyView(new AppAdjApplyModel(29))
		));
		$result['title'] = '添加';
	...
	public function edit ($params)
	{
		...
		$result = array('success' => 0,'error' => '');
		$result['content'] = $this->fetch('app_adj_apply_info.html',array(
			'view'=>new AppAdjApplyView(new AppAdjApplyModel($id,29)),
			'tab_id'=>$tab_id
		));
		$result['title'] = '编辑';
		Util::jsonExit($result);
	...
	public function show ($params)
	{
        ...
        $applyGoods = new AppAdjApplyGoodsModel(29);
        ...
        $this->render('app_adj_apply_show.html',array(
			'view'=>new AppAdjApplyView(new AppAdjApplyModel($id,29)),
	...
	public function update ($params)
	{
		...
		$newmodel =  new AppAdjApplyModel($id,30);
	...
	public function delete ($params)
	{
		$result = array('success' => 0,'error' => '');
		$id = intval($params['id']);
		$model = new AppAdjApplyModel($id,30);
