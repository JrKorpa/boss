...
$import("public/js/select2/select2.min.js",function(){
	util.setItem('orl','index.php?mod=shibao&con=StoneProcureList&act=search');//设定刷新的初始url
	util.setItem('formID','stone_procure_list_search_form');//设定搜索表单id
	util.setItem('listDIV','stone_procure_list_search_list');//设定列表数据容器id
