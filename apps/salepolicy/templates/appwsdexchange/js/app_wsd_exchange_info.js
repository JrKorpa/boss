$import("public/js/select2/select2.min.js",function(){
	var info_form_id = 'app_wsd_exchange_info';//form表单id
	var info_form_base_url = 'index.php?mod=salepolicy&con=AppWsdExchange&act=';//基本提交路径
	var info_id= '<%$view->get_wsd_id()%>';
