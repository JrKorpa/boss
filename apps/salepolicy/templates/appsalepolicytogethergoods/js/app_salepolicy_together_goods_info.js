$import(function(){
	var info_form_id = 'app_salepolicy_together_goods_info';//form表单id
	var info_form_base_url = 'index.php?mod=salepolicy&con=AppSalepolicyTogetherGoods&act=';//基本提交路径
	...
	var obj = function(){
		var initElements = function(){
			...
			//复选美化
//			var test = $("#"+info_form_id1+" input[type='checkbox']:not(.toggle, .make-switch)");
//			if (test.size() > 0) {
//				test.each(function () {
//					if ($(this).parents(".checker").size() == 0) {
//						$(this).show();
