$import(function(){
	var info_form_id = 'pay_confirm_info';//form表单id
	var info_form_base_url = 'index.php?mod=refund&con=PayConfirm&act=';//基本提交路径
	var info_id= '<%$id%>';
	...
	var obj = function(){
		...
		var initData = function(){
		    $('#pay_confirm_info textarea').empty();
            $('#pay_confirm_search_form input[name=pay_attach]').empty();
