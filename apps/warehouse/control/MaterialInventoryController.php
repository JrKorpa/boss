 ...
 *  -------------------------------------------------
 */
class MaterialInventoryController extends CommonController
{
	...
	public function index ($params)
	{
		...
		$this->render('material_inventory_search_form.html',
		    array(
		        'bar'=>Auth::getBar(),
		        'view'=>new MaterialInventoryView($model),
	...
	public function add ()
	{
		...
		$result['content'] = $this->fetch('material_inventory_info.html',array(
			'view'=>new MaterialInventoryView(new MaterialInventoryModel(21))
		));
		$result['title'] = '添加';
	...
	public function edit ($params)
	{
		...
		$result = array('success' => 0,'error' => '');
		$result['content'] = $this->fetch('material_inventory_info.html',array(
			'view'=>new MaterialInventoryView(new MaterialInventoryModel($id,21)),
			'tab_id'=>$tab_id
		));
		$result['title'] = '编辑';
		Util::jsonExit($result);
	...
	public function insert ($params)
	{
		...
		$newmodel =  new MaterialInventoryModel(22);
	...
	public function update ($params)
	{
		...
		$newmodel =  new MaterialInventoryModel($id,22);
	...
	public function delete ($params)
	{
		$result = array('success' => 0,'error' => '');
		$id = intval($params['id']);
		$model = new MaterialInventoryModel($id,22);
