...
/**
 *  -------------------------------------------------
 *   @file		: NoaccountRenewBillController.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class NoaccountRenewBillController extends CommonController
{
...
/**
	...
	public function insert ($params)
	{
        ...
        $data = array(
            ...
            'place_company_id'=>!empty($place_company_id[0])?$place_company_id[0]:0,
            'place_company_name'=>$place_company_id[1],
            'place_warehouse_id'=>!empty($place_warehouse_id[0])?$place_warehouse_id[0]:0,
