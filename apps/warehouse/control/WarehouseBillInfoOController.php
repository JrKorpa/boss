...
/**
 *  -------------------------------------------------
 *   @file		: WarehouseBillInfoOController.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class WarehouseBillInfoOController extends CommonController
{
...
/**
	...
	public function edit ($params)
	{
		...
		$model = new WarehouseBillInfoOModel(21);
...
/**
	...
	public function insert ($params)
	{
		...
		$data	= $_POST['data'];
		$model  = new WarehouseBillInfoOModel(22);
		...
		$to_warehouse_arr = explode('|', $params['to_warehouse_id']);
		$to_company_name = explode('|', $params['to_company_name']);
		$c_info = array(
			'bill_no'=>$bill_no,
			'to_company_id'=>$params['to_company_id'],
			'to_company_name'=>trim($to_company_name[1]),
			'to_warehouse_id'=>$to_warehouse_arr[0],
			'to_warehouse_name'=>trim($to_warehouse_arr[1]),
			'goods_num'=>0,
			'goods_total'=>0,
			'shijia'=>0,
	...
	public function delete ($params)
	{
		$result = array('success' => 0,'error' => '');
		$id = intval($params['id']);
		$model = new WarehouseBillInfoOModel($id,22);
