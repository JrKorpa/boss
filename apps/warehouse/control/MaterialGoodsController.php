 ...
 *  -------------------------------------------------
 */
class MaterialGoodsController extends CommonController
{
	...
	public function add ()
	{
		...
		$result['content'] = $this->fetch('material_goods_info.html',array(
			'view'=>new MaterialGoodsView(new MaterialGoodsModel(21))
		));
		$result['title'] = '添加';
	...
	public function edit ($params)
	{
		...
		$result = array('success' => 0,'error' => '');
		$result['content'] = $this->fetch('material_goods_info.html',array(
			'view'=>new MaterialGoodsView(new MaterialGoodsModel($id,21)),
			'tab_id'=>$tab_id
		));
		$result['title'] = '编辑';
		Util::jsonExit($result);
	...
	public function insert ($params)
	{
		...
		$newmodel =  new MaterialGoodsModel(22);
		$pdo = $newmodel->db()->db();
		try{
	...
	public function update ($params)
	{
		...
		$id = _Post::getInt('id');
		$newmodel =  new MaterialGoodsModel($id,22);
...
/**
	...
	public function onShelf($params){
	    ...
	    $model = new MaterialGoodsModel(22);
