...
/**
 *  -------------------------------------------------
 *   @file		: WarehouseBillInfoRController.php
 *   @link		:  www.kela.cn
 ...
 *  -------------------------------------------------
 */
class WarehouseBillInfoRController extends CommonController
{
	...
	public function add ()
	{
		...
		$result['content'] = $this->fetch('warehouse_bill_info_r_info.html',array(
			'view'=>new WarehouseBillInfoRView(new WarehouseBillInfoRModel(21))
		));
		$result['title'] = '添加';
	...
	public function insert ($params)
	{
		...
		$model  = new WarehouseBillInfoRModel(22);
		...
		//单据插入  商品插入
		$res= $model->add_info_r($data,$c_info);
	...
	public function delete ($params)
	{
		$result = array('success' => 0,'error' => '');
		$id = intval($params['id']);
		$model = new WarehouseBillInfoRModel($id,22);
