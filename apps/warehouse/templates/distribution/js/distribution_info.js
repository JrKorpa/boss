$import("public/js/jquery-tags-input/jquery.tagsinput.min.js",function(){
	...
	var Obj = function(){
		...
		var handleForm = function(){
			var url = 'index.php?mod=warehouse&con=Distribution&act=insert';
			var options1 = {
				url: url,
				error:function ()
				{
			...
			$('#distribution_push').validate({
				...
				submitHandler: function (form) {
					$("#distribution_push").ajaxSubmit(options1);
				}
			});
		};
		var initData=function(){
			$('#distribution_push button[type=reset]').click(function(){
