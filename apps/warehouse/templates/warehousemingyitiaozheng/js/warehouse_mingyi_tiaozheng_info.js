$import(function(){
	var info_form_id = 'warehouse_mingyi_tiaozheng_info';//form表单id
	var info_form_base_url = 'index.php?mod=warehouse&con=WarehouseMingyiTiaozheng&act=';//基本提交路径
...
//				}
				...
				$('#'+info_form_id+' select[name="shuoming"]').select2('val','').change();//single

				//$('#'+info_form_id+' select[name="shuoming"]').select2('val',[]).change();//multiple
			});		
		};
		return {
			init:function(){
