...
function detailedit(obj){
	...
	var _id = tObj[0].getAttribute("data-id").split('_').pop();
	var checkurl = "index.php?mod=warehouse&con=WarehouseBillA&act=checkList";
...
$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js",
	...
	util.setItem('orl','index.php?mod=warehouse&con=WarehouseBillA&act=search');
	util.setItem('listDIV','warehouse_bill_search_list1');
	util.setItem('formID','warehouse_bill_search_form1');
	...
	var WarehouseBillObj = function(){
		var initElements = function(){
			...
			$('#warehouse_bill_search_form1 select').select2({
				placeholder: "请选择",
				allowClear: true
		...
		var initData = function(){
			util.closeForm(util.getItem("formID"));		//合上搜索框
                        $('#warehouse_bill_search_form1 :reset').on('click',function(){
				$('#warehouse_bill_search_form1 input').val('');
                                $('#warehouse_bill_search_form1 select').select2("val",'');
			});
...
function download1(){
    ...
    var bill_no = $("#warehouse_bill_search_form1 [name='bill_no']").val();
    var order_sn = $("#warehouse_bill_search_form1 [name='order_sn']").val();
    var bill_type = $("#warehouse_bill_search_form1 [name='bill_type']").val();
    var bill_status = $("#warehouse_bill_search_form1 [name='bill_status']").val();
    var from_company_id = $("#warehouse_bill_search_form1 [name='from_company_id']").val();
    var to_company_id = $("#warehouse_bill_search_form1 [name='to_company_id']").val();
    var to_warehouse_id = $("#warehouse_bill_search_form1 [name='to_warehouse_id']").val();
    var processors = $("#warehouse_bill_search_form1 [name='processors']").val();
 	var account_type = $("#warehouse_bill_search_form1 [name='account_type']").val();
    var put_in_type = $("#warehouse_bill_search_form1 [name='put_in_type']").val();
    var mohao = $("#warehouse_bill_search_form1 [name='mohao']").val();
 	var goods_id = $("#warehouse_bill_search_form1 [name='goods_id']").val();
    var goods_sn = $("#warehouse_bill_search_form1 [name='goods_sn']").val();
    var create_user = $("#warehouse_bill_search_form1 [name='create_user']").val();
    var time_start = $("#warehouse_bill_search_form1 [name='time_start']").val();
    var time_end = $("#warehouse_bill_search_form1 [name='time_end']").val();
    var check_time_start = $("#warehouse_bill_search_form1 [name='check_time_start']").val();
    var check_time_end = $("#warehouse_bill_search_form1 [name='check_time_end']").val();
    var send_goods_sn = $("#warehouse_bill_search_form1 [name='send_goods_sn']").val();
    var bill_note = $("#warehouse_bill_search_form1 [name='bill_note']").val();
    ...
    location.href = "index.php?mod=warehouse&con=WarehouseBillA&act=search"+args;
