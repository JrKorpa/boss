$import(["public/js/select2/select2.min.js"],function(){
	var info_form_id = 'material_goods_info';//form表单id
	var info_form_base_url = 'index.php?mod=warehouse&con=MaterialGoodsJin&act=';//基本提交路径
...
//			}
		...
		var handleForm = function(){
			...
			$.validator.addMethod('syncstyleSn',function(value,element){
				var url = "index.php?mod=warehouse&con=MaterialGoodsJin&act=getStyleName";
				var res = false;
				$.ajax({
					url : url,
					async : false,
                    ...
                    success:function(result){
						if(result.success == 1){
							$('#'+info_form_id+' input[name="style_name"]').val(result['data']['style_name'])
							res = true;
						}
					}
				});
