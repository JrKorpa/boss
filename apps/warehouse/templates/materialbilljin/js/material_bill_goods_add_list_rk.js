...
$import(["public/js/select2/select2.min.js"],function(){
	...
	util.setItem('orl','index.php?mod=warehouse&con=MaterialBillJin&act=addBillGoodsSearchRK&_id='+getID().split('-').pop());
	util.setItem('listDIV','material_bill_goods_add_list_rk');
	var obj = function(){
