$import(["public/js/select2/select2.min.js"],function(){
	var info_form_id = 'material_bill_goods_add_ck_form';//form表单id
	...
	var obj = function(){
		...
		var handleForm = function(){
			var url = info_form_base_url+'insertBillGoodsCK';
			var options1 = {
				url: url,
				error:function ()
				{
					...
					if(data.success == 1 ){
						...
						util.xalert(
							...
							function(){								
								...
								//var url ='index.php?mod=warehouse&con=MaterialBillJin&act=show&id='+data.bill_id;
								//new_tab('materialbill-'+data.bill_id,data.bill_sn,url);
							}
						);
					}
					else
