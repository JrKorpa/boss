...
$import(["public/js/select2/select2.min.js"],function(){
	util.setItem('orl','index.php?mod=warehouse&con=MaterialInventoryJin&act=search');//设定刷新的初始url
...
function download(){
	...
	var url ="index.php?mod=warehouse&con=MaterialInventoryJin&act=search";
	$.each(form, function(){
		if(this.value!=''){
