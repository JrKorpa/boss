// 表格初始化
var from_table_data_o_edit = function (id, tdata, ttitle, ttype , bill_id) {
// var from_table_data_bill_m = function (id,title,tcolumns) {
  ...
  function obtain_info(id, x ,obj, bill_id,from_company_id){  //id 查询条件， table的x列数
    ...
    $.get("index.php?mod=warehouse&con=NoaccountReturnBill&act=getGoodsInfoByGoodsID", {goods_id: id, bill_id:bill_id,from_company_id:from_company_id }, function(data){
