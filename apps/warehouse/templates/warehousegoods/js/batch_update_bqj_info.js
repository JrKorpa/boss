$import(function(){
	var info_form_id = 'batch_update_bqj_info';//form表单id
	var info_form_base_url = 'index.php?mod=warehouse&con=WarehouseGoods&act=';//基本提交路径
	var info_id= '';
...
//			});	
		...
		var handleForm = function(){
			var url = info_form_base_url+(info_id ? 'update' : 'batchUpdateBqjInsert');
			var options1 = {
				url: url,
				error:function ()
				{
