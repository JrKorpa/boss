// 表格初始化
var from_table_data_c = function (id, tdata, ttitle, ttype) {
  var $container = $(id);
 ...
 // 批量获取添加输入值
    function getBatchInfo(idArry,x,n,obj){  //id 查询条件， table的x行数
        ...
        var from_company_id_c = $("#from_company_id_c").val();
        //alert(from_company_id_c);
        $.get("index.php?mod=warehouse&con=WarehouseBillInfoC&act=getGoodsInfos", {'g_ids':idArry,'bill_id':bill_id,'from_company_id_c':from_company_id_c}, function(data){
