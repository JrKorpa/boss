...
//分页
function order_fqc_search_page(url){
	util.page(url);
}
...
$import(["public/js/bootstrap-datepicker/js/bootstrap-datepicker.js", "public/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js","public/js/select2/select2.min.js"],function(){
	...
	util.setItem('formID','order_fqc_search_form');//设定搜索表单id
	...
	var obj = function(){
		...
		var initElements = function(){
                    ...
                    $('#order_fqc_search_form select').select2({
                            placeholder: "请选择",
                            allowClear: true
                    ...
                    $('#order_fqc_search_form :reset').on('click',function(){
                            $('#order_fqc_search_form select').select2("val","");
                    })
		...
		var initData = function(){
			...
			order_fqc_search_page(util.getItem("orl"));
		}
		return {
			init:function(){
