$import(["public/js/select2/select2.min.js",
	...
	var info_form_id = 'order_fqc_conf_info';//form表单id
	var info_form_base_url = 'index.php?mod=warehouse&con=OrderFqcConf&act=';//基本提交路径
	...
	var obj = function(){
		var initElements = function(){
			...
			$('#order_fqc_conf_info select[name="parent_id"]').select2({
				placeholder: "请选择",
				allowClear: true
			}).change(function(e){
				$(this).valid();
