...
var from_table_data_o = function (id, tdata, ttitle, ttype) {
  ...
  function obtain_info(id, x,obj,from_company_id){  //id 查询条件， table的x列数
    ...
    $.get("index.php?mod=warehouse&con=WarehouseBillInfoO&act=getGoodsInfoByGoodsID", {goods_id: id , from_company_id:from_company_id,to_company_name:to_company_name}, function(data){
