// 表格初始化
var from_table_data_e = function (id,tdata,title,tcolumns) {
  var $container = $(id);
  //表格基本内容初始化
  ...
  function obtain_info(id, x,obj,from_company_id){  //id 查询条件， table的x列数
    $.get("index.php?mod=warehouse&con=WarehouseBillInfoE&act=getGoodsInfoByGoodsID", {goods_id: id,from_company_id:from_company_id}, function(data){
