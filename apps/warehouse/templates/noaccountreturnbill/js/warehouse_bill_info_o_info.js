...
$import(
	...
	"public/js/jquery.handsontable.full.js",	//明细table插件
				...
				var from_table1 = function(){
					$.ajax({
						...
						success : function(res){
							//from_table_data_bill_o(res.id,res.data_bill_m, res.title,res.columns);
			...
			util.setItem('orl','index.php?mod=warehouse&con=NoaccountReturnBill&act=getGoodsInDetails&bill_id='+info_id);
