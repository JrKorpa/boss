$import(["public/js/select2/select2.min.js"], function(){
	var info_form_id = 'tsyd_jxs_delivery_info';//form表单id
	var info_form_base_url = 'index.php?mod=shipping&con=TsydJxsDelivery&act=';//基本提交路径
...
function print_express(){
	...
	if(express_id==''){alert('请选择快递方式');return false;}
	window.open('/index.php?mod=shipping&con=TsydJxsDelivery&act=print_express&order_no=<%$order_sn%>&express_id='+express_id,'','fullscreen:true,menubar:false,resizable:false,titlebar:false,toolbar:false')
}