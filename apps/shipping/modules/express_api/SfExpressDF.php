...
class SfExpressDF {
        ...
        public static function makeOrder($order_id,$data){
            ...
            //        if(isset($res['result']) && $res['result']==0 && $res['error']=='找不到该订单'){
                        $body ="<?xml version='1.0' encoding='UTF-8' ?><Request service='OrderService' lang='zh-CN'><Head>".self::_CHECKHEADER."</Head><Body><Order orderid='".$order_id."' is_gen_bill_no='1' pay_method='2' ";
