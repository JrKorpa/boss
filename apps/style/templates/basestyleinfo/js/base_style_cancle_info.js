$import(function(){
	var info_form_id = 'base_style_cancle_info';//form表单id
	var info_form_base_url = 'index.php?mod=style&con=BaseStyleInfo&act=';//基本提交路径
	var info_id= '<%$view->get_style_id()%>';
...
//			}
		...
		var handleForm = function(){
			var url = info_form_base_url+(info_id ? 'cancle_apply_submit' : 'cancle_apply_submit');
			var options1 = {
				url: url,
				error:function ()
				{
