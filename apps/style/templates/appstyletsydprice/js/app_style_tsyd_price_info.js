$import("public/js/select2/select2.min.js",function(){
	var info_form_id = 'app_style_tsyd_price_info';//form表单id
	var info_form_base_url = 'index.php?mod=style&con=AppStyleTsydPrice&act=';//基本提交路径
	...
	var obj = function(){
		var initElements = function(){
			//单选美化
			//初始化单选按钮组
			$('#app_style_tsyd_price_info select').select2({
				placeholder: "全部",
				allowClear: true,
			}).change(function(e){
				$(this).valid();
