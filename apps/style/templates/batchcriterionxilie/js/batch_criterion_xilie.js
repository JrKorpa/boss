$import(function(){
	...
	var obj = function(){
		...
		var handleForm1 = function(){
            var info_form_id1 = 'batch_criterion_xilie';
			var url = 'index.php?mod=style&con=BatchCriterionXiLie&act=uploadfile';
			var options1 = {
				url: url,
				error:function ()
				{
        ...
        var initData = function(){
            $(".xzmb").on('click', function(){
                location.href = "index.php?mod=style&con=BatchCriterionXiLie&act=download_xiangkou_demo";
            });
        }
