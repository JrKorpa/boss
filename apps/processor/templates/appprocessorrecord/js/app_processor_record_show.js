...
$import("public/js/select2/select2.min.js",function(){
    ...
    util.setItem('orl', 'index.php?mod=processor&con=AppProcessorRecord&act=getLog');//设定刷新的初始url
    ...
    audit_btn.click(function(){
        ...
        $.post(url,data, function(e){
           switch(e){
            ...
            util.xalert(msg,
                function(){
                    var url = 'index.php?mod=processor&con=AppProcessorRecord&act=mkCheckLog';
    ...
    var sunmitObj = function(){
        ...
        var handleForm = function(){
            var url = 'index.php?mod=processor&con=AppProcessorRecord&act=sunmitCause';
            var options1 = {
                url:url,
                error:function ()
                {
        ...
        var initData = function(){
            var url = 'index.php?mod=processor&con=AppProcessorRecord&act=getLog';
