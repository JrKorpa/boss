    ...
    var obj = function() {
        var initElements = function() {
            ...
            $('#app_processor_record_info input[name="name"]').blur(function(){
                var url = 'index.php?mod=processor&con=AppProcessorRecord&act=autoCode';
            ...
            $('#app_processor_record_info select[name="business_license_region_1"]').select2({
                ...
                var _t = $(this).val();
                if (_t) {
                    $.post('index.php?mod=processor&con=AppProcessorRecord&act=getCity', {province: _t}, function(data) {
            ...
            $('#app_processor_record_info select[name="business_license_region_2"]').select2({
                ...
                var _t = $(this).val();
                if (_t) {
                    $.post('index.php?mod=processor&con=AppProcessorRecord&act=getDistrict', {city: _t}, function (data) {
            ...
            $('#app_processor_tax_point_btn a').on('click',function(){
                ...
                if (!li.hasClass('disabled')) {
                    ...
                    var label = $(this).text();
                    var url = 'index.php?mod=processor&con=AppProcessorRecord&act=getPoint';
        ...
        var handleForm = function() {
            var url = info_id ? 'index.php?mod=processor&con=AppProcessorRecord&act=update' : 'index.php?mod=processor&con=AppProcessorRecord&act=insert';
            var options1 = {
                url: url,
                error: function(){
                    $('.modal-scrollable').trigger('click');
            ...
            $('#app_processor_record_info').validate({
                ...
                rules: {
                    name: {required:true,maxlength:30,remote:'index.php?mod=processor&con=AppProcessorRecord&act=checkCode'},
...
//                    i++;
//                }
                var url = 'index.php?mod=processor&con=AppProcessorRecord&act=showPoint';
