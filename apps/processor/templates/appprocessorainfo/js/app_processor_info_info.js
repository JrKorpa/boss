$import(['public/js/select2/select2.min.js', 'public/js/jquery.validate.extends.js'], function() {
    ...
    var AppProcessorAInfoInfo = function() {
        ...
        var initElements = function() {
            ...
            $('#app_processor_info_info select[name="business_license_region_1"]').select2({
                ...
                var _t = $(this).val();
                if (_t) {
                    $.post('index.php?mod=processor&con=AppProcessorAInfo&act=getCity', {province: _t}, function(data) {
            ...
            $('#app_processor_info_info select[name="business_license_region_2"]').select2({
                ...
                var _t = $(this).val();
                if (_t) {
                    $.post('index.php?mod=processor&con=AppProcessorAInfo&act=getDistrict', {city: _t}, function (data) {
        ...
        var handleForm = function() {
            var url = app_processor_info_id ? 'index.php?mod=processor&con=AppProcessorAInfo&act=update' : 'index.php?mod=processor&con=AppProcessorAInfo&act=insert';
            var options1 = {
                url: url,
                error: function()
                {
