 ...
 *  -------------------------------------------------
 */
class AppProcessorRecordController extends CommonController {
    ...
    public function index($params) {
		$view = new AppProcessorRecordView(new AppProcessorRecordModel(13));
    ...
    public function edit($params) {
        ...
        $this->render('app_processor_record_info.html', array(
            'view' => new AppProcessorRecordView(new AppProcessorRecordModel($id,13)),
            'dict'=>new DictView(new DictModel(1))
        ));
    ...
    public function insert() {
        ...
        $newdo['is_A_company'] = 'N';//是否A公司
        if(empty($newdo['department_id'])){
            $result['error'] = '请选择申请部门!!!';
            Util::jsonExit($result);
        }

        $newmodel = new AppProcessorRecordModel(14);
        ...
        if ($res !== false) {
            /*-----更新审核人-----*/
            $model = new AppProcessorRecordModel($res,14);
            $view = new AppProcessorRecordView($model);
    ...
    public function update() {
        ...
        $newmodel = new AppProcessorRecordModel($id, 14);
        $olddo = $newmodel->getDataObject();
        $res = $newmodel->saveData($newdo, $olddo);
        if ($res !== false) {
            /*-----更新审核人-----*/
            $model = new AppProcessorRecordModel($id,14);
            $view = new AppProcessorRecordView($model);
            $porcess_id = $view->getProcess();//流程ID
            if($porcess_id){
                $user_id = $view->getCurrentCheckUser($porcess_id,1);
    ...
    public function mkCheckLog(){
        ...
        $view = new AppProcessorRecordView(new AppProcessorRecordModel($record_id,13));
    ...
    public function submit($params){
        ...
        $id = intval($params['id']);
        $model = new AppProcessorRecordModel($id,14);
        $v = new AppProcessorRecordView($model);
    ...
    */
    public function cancelApply($params){
        ...
        $id = intval($params['id']);
        $recordmodel = new AppProcessorRecordModel($id,14);
