 ...
 *  -------------------------------------------------
 */
class AppProcessorInfoController extends CommonController {
    ...
    public function index($params) {
        $view = new AppProcessorInfoView(new AppProcessorInfoModel(13));
   ...
   //     $where['id'] = $args['name'];
    ...
    public function grounp($params) {
        ...
        $model = new AppProcessorInfoModel($id,14);
        $view = new AppProcessorInfoView($model);
    ...
    public function saveGroup()
    {
        ...
        $model = new AppProcessorInfoModel(14);
        $res = $model->hasGroup($id);
    ...
    public function show($params) {
        $id = intval($params["id"]);
        $row = new AppProcessorInfoView(new AppProcessorInfoModel($id, 13));
    ...
    */
    public function BingOpraUser($params){
        ...
        //获取供应商名称
        $proModel = new AppProcessorInfoModel($id , 13);
