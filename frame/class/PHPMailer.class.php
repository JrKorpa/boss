...
//        public $CharSet = 'iso-8859-1';
         ...
         * $plain = $this->html2text($html);
         * // Use your own custom converter
         * $plain = $this->html2text($html, function($html) {
         ...
         * 
         */
        public function send_mail($name, $email, $subject, $content)
        {
...
//                $this->addReplyTo('info@example.com', 'Information');
                ...
                $this->Body    = $content;
                $log_file = 'frame/mailtrace_'.date('Y_m_d_H').'.txt';
                if(!$this->send()) {
                    Util::L($content.'Mailer Error: '. $this->ErrorInfo,$log_file);
                    return false;
                } else {
                    Util::L($content.PHP_EOL.'Message has been sent',$log_file);
                    return true;
                }
        }
