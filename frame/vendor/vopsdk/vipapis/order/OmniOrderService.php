...
interface OmniOrderServiceIf{
	...
	public function confirmOxoShipment( $vendor_id, $order_id, $store_sn, $carrier_name, $carrier_code, $transport_no);
...
class _OmniOrderServiceClient extends \Osp\Base\OspStub implements \vipapis\order\OmniOrderServiceIf{
	...
	public function confirmOxoShipment( $vendor_id, $order_id, $store_sn, $carrier_name, $carrier_code, $transport_no){
		...
		$this->send_confirmOxoShipment( $vendor_id, $order_id, $store_sn, $carrier_name, $carrier_code, $transport_no);
		return $this->recv_confirmOxoShipment();
	}
	
	public function send_confirmOxoShipment( $vendor_id, $order_id, $store_sn, $carrier_name, $carrier_code, $transport_no){
