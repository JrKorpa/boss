...
interface MerchModelServiceIf{
	...
	public function batchBind( $materialId, $bindInfoModels);
	
	public function bind( $materialId,\com\vip\arplatform\merchModel\service\BindInfoModel $bindInfoModel);
	...
	public function search(\com\vip\arplatform\merchModel\service\SearchParams $parameters, $page, $limit, $sortField, $sort);
	
	public function setStatus( $materialId, $status);
	
	public function syncFromJD( $syncDatum);
	
	public function unbind( $materialId,\com\vip\arplatform\merchModel\service\BindInfoModel $bindInfoModel);
...
class _MerchModelServiceClient extends \Osp\Base\OspStub implements \com\vip\arplatform\merchModel\service\MerchModelServiceIf{
	...
	public function batchBind( $materialId, $bindInfoModels){
		...
		$this->send_batchBind( $materialId, $bindInfoModels);
		return $this->recv_batchBind();
	}
	
	public function send_batchBind( $materialId, $bindInfoModels){
		...
		$args->bindInfoModels = $bindInfoModels;
	...
	public function send_bind( $materialId,\com\vip\arplatform\merchModel\service\BindInfoModel $bindInfoModel){
	...
	public function search(\com\vip\arplatform\merchModel\service\SearchParams $parameters, $page, $limit, $sortField, $sort){
		...
		$this->send_search( $parameters, $page, $limit, $sortField, $sort);
		return $this->recv_search();
	}
	
	public function send_search(\com\vip\arplatform\merchModel\service\SearchParams $parameters, $page, $limit, $sortField, $sort){
		
		$this->initInvocation("search");
		$args = new \com\vip\arplatform\merchModel\service\MerchModelService_search_args();
	...
	public function recv_search(){
		...
		$result = new \com\vip\arplatform\merchModel\service\MerchModelService_search_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function setStatus( $materialId, $status){
		...
		$this->send_setStatus( $materialId, $status);
		return $this->recv_setStatus();
	}
	
	public function send_setStatus( $materialId, $status){
		
		$this->initInvocation("setStatus");
		$args = new \com\vip\arplatform\merchModel\service\MerchModelService_setStatus_args();
	...
	public function recv_setStatus(){
		
		$result = new \com\vip\arplatform\merchModel\service\MerchModelService_setStatus_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_unbind( $materialId,\com\vip\arplatform\merchModel\service\BindInfoModel $bindInfoModel){
...
class MerchModelService_batchBind_args {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['bindInfoModels'])){
				
				$this->bindInfoModels = $vals['bindInfoModels'];
			}
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->bindInfoModels[$_size0++] = $elem0;
				}
				catch(\Exception $e){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('bindInfoModels');
		...
		foreach ($this->bindInfoModels as $iter0){
...
class MerchModelService_bind_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->bindInfoModel = new \com\vip\arplatform\merchModel\service\BindInfoModel();
...
class MerchModelService_search_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->parameters = new \com\vip\arplatform\merchModel\service\SearchParams();
...
class MerchModelService_setStatus_args {
...
class MerchModelService_getBindInfoBySku_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\arplatform\merchModel\service\BindInfoModel();
...
class MerchModelService_search_result {
...
class MerchModelService_setStatus_result {
