...
class InventoryOccupiedOrderSyncServiceClient{
	...
	public static function getService(){
		...
		if (! InventoryOccupiedOrderSyncServiceClient::$isRegis){
			
			InventoryOccupiedOrderSyncServiceClient::regis ();
			InventoryOccupiedOrderSyncServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InventoryOccupiedOrderSyncServiceClient::$DEFAULT_PROXY_IP;
		$port = InventoryOccupiedOrderSyncServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\sync\InventoryOccupiedOrderSyncServiceHelper();
	}
