...
class _ProductSchemaServiceClient extends \Osp\Base\OspStub implements \com\vip\isv\schema\ProductSchemaServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.isv.schema.ProductSchemaService", "1.0.0");
	}
	...
	public function send_createProductBySchema(\com\vip\isv\schema\CreateProductBySchemaRequest $createProductSchemaRequest){
		...
		$args = new \com\vip\isv\schema\ProductSchemaService_createProductBySchema_args();
	...
	public function recv_createProductBySchema(){
		...
		$result = new \com\vip\isv\schema\ProductSchemaService_createProductBySchema_result();
	...
	public function send_getProductSchema(\com\vip\isv\schema\GetProductSchemaRequest $getProductSchemaRequest){
		...
		$args = new \com\vip\isv\schema\ProductSchemaService_getProductSchema_args();
	...
	public function recv_getProductSchema(){
		...
		$result = new \com\vip\isv\schema\ProductSchemaService_getProductSchema_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_healthCheck(){
		...
		$args = new \com\vip\isv\schema\ProductSchemaService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \com\vip\isv\schema\ProductSchemaService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_updateProductBySchema(\com\vip\isv\schema\UpdateProductBySchemaRequest $updateProductSchemaRequest){
		...
		$args = new \com\vip\isv\schema\ProductSchemaService_updateProductBySchema_args();
	...
	public function recv_updateProductBySchema(){
		...
		$result = new \com\vip\isv\schema\ProductSchemaService_updateProductBySchema_result();
		$this->receive_base($result);
		if ($result->success !== null){
