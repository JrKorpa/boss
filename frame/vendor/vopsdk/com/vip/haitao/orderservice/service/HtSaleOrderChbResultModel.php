...
class HtSaleOrderChbResultModel {
	...
	public $declareType = null;
	public $buyerIdtype = null;
	public $payerName = null;
	public $payerIdtype = null;
	public $payerIdnumber = null;
	public $payerTelephone = null;
	public $logisticsCode = null;
	public $logisticsName = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['isPackage'])){
				
				$this->isPackage = $vals['isPackage'];
			}
			
			
			if (isset($vals['declareType'])){
				
				$this->declareType = $vals['declareType'];
			}
			
			
			if (isset($vals['buyerIdtype'])){
				
				$this->buyerIdtype = $vals['buyerIdtype'];
			}
			
			
			if (isset($vals['payerName'])){
				
				$this->payerName = $vals['payerName'];
			}
			
			
			if (isset($vals['payerIdtype'])){
				
				$this->payerIdtype = $vals['payerIdtype'];
			}
			
			
			if (isset($vals['payerIdnumber'])){
				
				$this->payerIdnumber = $vals['payerIdnumber'];
			}
			
			
			if (isset($vals['payerTelephone'])){
				
				$this->payerTelephone = $vals['payerTelephone'];
			}
			
			
			if (isset($vals['logisticsCode'])){
				
				$this->logisticsCode = $vals['logisticsCode'];
			}
			
			
			if (isset($vals['logisticsName'])){
				
				$this->logisticsName = $vals['logisticsName'];
			}
	...
	public function getName(){
		...
		return 'HtSaleOrderChbResultModel';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("isPackage" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->isPackage); 
			...
			if ("declareType" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->declareType); 
			...
			if ("buyerIdtype" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->buyerIdtype); 
			...
			if ("payerName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->payerName);
			...
			if ("payerIdtype" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->payerIdtype); 
			...
			if ("payerIdnumber" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->payerIdnumber);
			...
			if ("payerTelephone" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->payerTelephone);
			...
			if ("logisticsCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->logisticsCode);
			...
			if ("logisticsName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->logisticsName);
			...
			if ("HtSaleOrderInfoVopModelList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->HtSaleOrderInfoVopModelList[$_size1++] = $elem1;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('isPackage');
		$xfer += $output->writeI32($this->isPackage);
		
		$xfer += $output->writeFieldEnd();
		
		$xfer += $output->writeFieldBegin('declareType');
		$xfer += $output->writeI32($this->declareType);
		
		$xfer += $output->writeFieldEnd();
		
		$xfer += $output->writeFieldBegin('buyerIdtype');
		$xfer += $output->writeI32($this->buyerIdtype);
		
		$xfer += $output->writeFieldEnd();
		
		if($this->payerName !== null) {
			
			$xfer += $output->writeFieldBegin('payerName');
			$xfer += $output->writeString($this->payerName);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		$xfer += $output->writeFieldBegin('payerIdtype');
		$xfer += $output->writeI32($this->payerIdtype);
		
		$xfer += $output->writeFieldEnd();
		
		if($this->payerIdnumber !== null) {
			
			$xfer += $output->writeFieldBegin('payerIdnumber');
			$xfer += $output->writeString($this->payerIdnumber);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->payerTelephone !== null) {
			
			$xfer += $output->writeFieldBegin('payerTelephone');
			$xfer += $output->writeString($this->payerTelephone);
		...
		if($this->logisticsCode !== null) {
			...
			$xfer += $output->writeFieldBegin('logisticsCode');
			$xfer += $output->writeString($this->logisticsCode);
		...
		if($this->logisticsName !== null) {
			...
			$xfer += $output->writeFieldBegin('logisticsName');
			$xfer += $output->writeString($this->logisticsName);
