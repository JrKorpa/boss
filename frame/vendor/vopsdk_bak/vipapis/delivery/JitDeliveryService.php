...
interface JitDeliveryServiceIf{
	...
	public function createDelivery( $vendor_id, $po_no, $delivery_no, $warehouse, $delivery_time, $arrival_time, $race_time, $carrier_name, $tel, $driver, $driver_tel, $plate_number, $page, $limit, $delivery_method, $store_sn, $carrier_code);
	
	public function createMultiPoDelivery(\vipapis\delivery\CreateMultiPoDeliveryRequest $createMultiPoDeliveryRequest);
	
	public function createPick( $po_no, $vendor_id, $co_mode);
	...
	public function getPoList( $st_create_time, $et_create_time, $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $st_sell_et_time, $et_sell_et_time, $page, $limit);
	
	public function getPoOrders( $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $page, $limit);
...
class _JitDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\delivery\JitDeliveryServiceIf{
	...
	public function createDelivery( $vendor_id, $po_no, $delivery_no, $warehouse, $delivery_time, $arrival_time, $race_time, $carrier_name, $tel, $driver, $driver_tel, $plate_number, $page, $limit, $delivery_method, $store_sn, $carrier_code){
		...
		$this->send_createDelivery( $vendor_id, $po_no, $delivery_no, $warehouse, $delivery_time, $arrival_time, $race_time, $carrier_name, $tel, $driver, $driver_tel, $plate_number, $page, $limit, $delivery_method, $store_sn, $carrier_code);
		return $this->recv_createDelivery();
	}
	
	public function send_createDelivery( $vendor_id, $po_no, $delivery_no, $warehouse, $delivery_time, $arrival_time, $race_time, $carrier_name, $tel, $driver, $driver_tel, $plate_number, $page, $limit, $delivery_method, $store_sn, $carrier_code){
	...
	public function createPick( $po_no, $vendor_id, $co_mode){
		...
		$this->send_createPick( $po_no, $vendor_id, $co_mode);
		return $this->recv_createPick();
	}
	
	public function send_createPick( $po_no, $vendor_id, $co_mode){
	...
	public function getPoList( $st_create_time, $et_create_time, $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $st_sell_et_time, $et_sell_et_time, $page, $limit){
		...
		$this->send_getPoList( $st_create_time, $et_create_time, $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $st_sell_et_time, $et_sell_et_time, $page, $limit);
		return $this->recv_getPoList();
	}
	
	public function send_getPoList( $st_create_time, $et_create_time, $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $st_sell_et_time, $et_sell_et_time, $page, $limit){
	...
	public function getPoOrders( $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $page, $limit){
		...
		$this->send_getPoOrders( $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $page, $limit);
		return $this->recv_getPoOrders();
	}
	
	public function send_getPoOrders( $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $page, $limit){
