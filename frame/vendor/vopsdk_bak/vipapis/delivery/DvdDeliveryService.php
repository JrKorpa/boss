...
interface DvdDeliveryServiceIf{
	...
	public function getOrderList( $st_add_time, $et_add_time, $order_status, $po_no, $order_id, $vendor_id, $page, $limit);
	
	public function getOrderListByCreateTime( $st_create_time, $et_create_time, $order_status, $po_no, $order_id, $vendor_id, $page, $limit);
	
	public function getOrderStatusById( $vendor_id, $order_id);
...
class _DvdDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\delivery\DvdDeliveryServiceIf{
	...
	public function getOrderList( $st_add_time, $et_add_time, $order_status, $po_no, $order_id, $vendor_id, $page, $limit){
		...
		$this->send_getOrderList( $st_add_time, $et_add_time, $order_status, $po_no, $order_id, $vendor_id, $page, $limit);
		return $this->recv_getOrderList();
	}
	
	public function send_getOrderList( $st_add_time, $et_add_time, $order_status, $po_no, $order_id, $vendor_id, $page, $limit){
	...
	public function getOrderStatusById( $vendor_id, $order_id){
		...
		$this->send_getOrderStatusById( $vendor_id, $order_id);
		return $this->recv_getOrderStatusById();
	}
	
	public function send_getOrderStatusById( $vendor_id, $order_id){
