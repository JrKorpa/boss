...
interface InventoryServiceIf{
	...
	public function getSkuStock( $vendor_id, $cooperation_no, $warehouse, $barcode);
...
class _InventoryServiceClient extends \Osp\Base\OspStub implements \vipapis\inventory\InventoryServiceIf{
	...
	public function getSkuStock( $vendor_id, $cooperation_no, $warehouse, $barcode){
		...
		$this->send_getSkuStock( $vendor_id, $cooperation_no, $warehouse, $barcode);
		return $this->recv_getSkuStock();
	}
	
	public function send_getSkuStock( $vendor_id, $cooperation_no, $warehouse, $barcode){
