...
interface VendorProductQueryServiceIf{
	...
	public function queryByBarcode( $vendor_id, $barcode);
	
	public function queryByBrandAndSn( $vendor_id, $brand_id, $sn);
...
class _VendorProductQueryServiceClient extends \Osp\Base\OspStub implements \vipapis\product\VendorProductQueryServiceIf{
	...
	public function queryByBarcode( $vendor_id, $barcode){
		...
		$this->send_queryByBarcode( $vendor_id, $barcode);
		return $this->recv_queryByBarcode();
	}
	
	public function send_queryByBarcode( $vendor_id, $barcode){
	...
	public function queryByBrandAndSn( $vendor_id, $brand_id, $sn){
		...
		$this->send_queryByBrandAndSn( $vendor_id, $brand_id, $sn);
		return $this->recv_queryByBrandAndSn();
	}
	
	public function send_queryByBrandAndSn( $vendor_id, $brand_id, $sn){
