...
interface VendorProductServiceIf{
	...
	public function getRealVendorSkuByBarcode( $vendor_id, $barcode);
	
	public function getSpuBySnVendorIdAndBrandId( $sn, $vendor_id, $brand_id);
	
	public function getVendorImageRelationshipTaskStatus( $task_id_list);
	
	public function healthCheck();
	
	public function multiGetProductSkuInfo( $vendor_id, $barcode, $brand_id, $category_id, $sn, $page, $limit);
	
	public function multiGetProductSpuInfo( $vendor_id, $brand_id, $category_id, $sn, $status, $page, $limit);
...
class _VendorProductServiceClient extends \Osp\Base\OspStub implements \vipapis\product\VendorProductServiceIf{
	...
	public function getRealVendorSkuByBarcode( $vendor_id, $barcode){
		...
		$this->send_getRealVendorSkuByBarcode( $vendor_id, $barcode);
		return $this->recv_getRealVendorSkuByBarcode();
	}
	
	public function send_getRealVendorSkuByBarcode( $vendor_id, $barcode){
	...
	public function getSpuBySnVendorIdAndBrandId( $sn, $vendor_id, $brand_id){
		...
		$this->send_getSpuBySnVendorIdAndBrandId( $sn, $vendor_id, $brand_id);
		return $this->recv_getSpuBySnVendorIdAndBrandId();
	}
	
	public function send_getSpuBySnVendorIdAndBrandId( $sn, $vendor_id, $brand_id){
	...
	public function multiGetProductSkuInfo( $vendor_id, $barcode, $brand_id, $category_id, $sn, $page, $limit){
		...
		$this->send_multiGetProductSkuInfo( $vendor_id, $barcode, $brand_id, $category_id, $sn, $page, $limit);
		return $this->recv_multiGetProductSkuInfo();
	}
	
	public function send_multiGetProductSkuInfo( $vendor_id, $barcode, $brand_id, $category_id, $sn, $page, $limit){
	...
	public function multiGetProductSpuInfo( $vendor_id, $brand_id, $category_id, $sn, $status, $page, $limit){
		...
		$this->send_multiGetProductSpuInfo( $vendor_id, $brand_id, $category_id, $sn, $status, $page, $limit);
		return $this->recv_multiGetProductSpuInfo();
	}
	
	public function send_multiGetProductSpuInfo( $vendor_id, $brand_id, $category_id, $sn, $status, $page, $limit){
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->sku_item_list[$_size1++] = $elem1;
				}
				catch(\Exception $e){
