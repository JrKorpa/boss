...
interface TransferringOrderApiServiceIf{
	...
	public function updateTransferringReceivedQuantity( $transferring_order_no, $received_date, $received_warehouse_code, $transferring_order_received);
	
	public function updateTransferringWopReceivedQuantity( $transferring_order_no, $batch_no, $batch_line_count, $out_order_no, $received_warehouse_code, $received_date, $received_items);
...
class _TransferringOrderApiServiceClient extends \Osp\Base\OspStub implements \vipapis\xstore\cc\transferring\api\TransferringOrderApiServiceIf{
	...
	public function updateTransferringReceivedQuantity( $transferring_order_no, $received_date, $received_warehouse_code, $transferring_order_received){
		...
		$this->send_updateTransferringReceivedQuantity( $transferring_order_no, $received_date, $received_warehouse_code, $transferring_order_received);
		return $this->recv_updateTransferringReceivedQuantity();
	}
	
	public function send_updateTransferringReceivedQuantity( $transferring_order_no, $received_date, $received_warehouse_code, $transferring_order_received){
	...
	public function updateTransferringWopReceivedQuantity( $transferring_order_no, $batch_no, $batch_line_count, $out_order_no, $received_warehouse_code, $received_date, $received_items){
		...
		$this->send_updateTransferringWopReceivedQuantity( $transferring_order_no, $batch_no, $batch_line_count, $out_order_no, $received_warehouse_code, $received_date, $received_items);
		return $this->recv_updateTransferringWopReceivedQuantity();
	}
	
	public function send_updateTransferringWopReceivedQuantity( $transferring_order_no, $batch_no, $batch_line_count, $out_order_no, $received_warehouse_code, $received_date, $received_items){
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem1 = new \vipapis\xstore\cc\transferring\api\TransferringWopReceivedQty();
					$elem1->read($input);
					
					$this->received_items[$_size1++] = $elem1;
				}
				catch(\Exception $e){
