...
interface TpcExternalServiceIf{
	...
	public function getForwardAddress(\com\vip\tpc\api\model\GetReturnAddressRequest $getReturnAddressRequest);
...
class _TpcExternalServiceClient extends \Osp\Base\OspStub implements \vipapis\tpc\service\TpcExternalServiceIf{
	...
	public function getForwardAddress(\com\vip\tpc\api\model\GetReturnAddressRequest $getReturnAddressRequest){
		...
		$this->send_getForwardAddress( $getReturnAddressRequest);
		return $this->recv_getForwardAddress();
	}
	
	public function send_getForwardAddress(\com\vip\tpc\api\model\GetReturnAddressRequest $getReturnAddressRequest){
		
		$this->initInvocation("getForwardAddress");
		$args = new \vipapis\tpc\service\TpcExternalService_getForwardAddress_args();
	...
	public function recv_getForwardAddress(){
		
		$result = new \vipapis\tpc\service\TpcExternalService_getForwardAddress_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class TpcExternalService_getForwardAddress_args {
...
class TpcExternalService_getForwardAddress_result {
