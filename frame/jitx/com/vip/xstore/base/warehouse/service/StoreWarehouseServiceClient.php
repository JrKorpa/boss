...
class StoreWarehouseServiceClient{
	...
	public static function getService(){
		...
		if (! StoreWarehouseServiceClient::$isRegis){
			
			StoreWarehouseServiceClient::regis ();
			StoreWarehouseServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = StoreWarehouseServiceClient::$DEFAULT_PROXY_IP;
		$port = StoreWarehouseServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\xstore\base\warehouse\service\StoreWarehouseServiceHelper();
	}
