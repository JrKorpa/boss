...
class AppConfigServiceClient{
	...
	public static function getService(){
		...
		if (! AppConfigServiceClient::$isRegis){
			
			AppConfigServiceClient::regis ();
			AppConfigServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AppConfigServiceClient::$DEFAULT_PROXY_IP;
		$port = AppConfigServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\common\config\AppConfigServiceHelper();
	}
