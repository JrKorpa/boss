...
class OaInfoServiceClient{
	...
	public static function getService(){
		...
		if (! OaInfoServiceClient::$isRegis){
			
			OaInfoServiceClient::regis ();
			OaInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OaInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = OaInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\common\oa\OaInfoServiceHelper();
	}
