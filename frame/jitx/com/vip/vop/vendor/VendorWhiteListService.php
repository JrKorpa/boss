...
interface VendorWhiteListServiceIf{
	...
	public function getCooperationNoConfigInfo( $vendorId, $cooperationNo, $vendorCode);
	...
	public function modifyCooperationNoConfig(\com\vip\vop\vendor\ModifyCooperationNoConfigRequired $param);
...
class _VendorWhiteListServiceClient extends \Osp\Base\OspStub implements \com\vip\vop\vendor\VendorWhiteListServiceIf{
	...
	public function getCooperationNoConfigInfo( $vendorId, $cooperationNo, $vendorCode){
		...
		$this->send_getCooperationNoConfigInfo( $vendorId, $cooperationNo, $vendorCode);
		return $this->recv_getCooperationNoConfigInfo();
	}
	
	public function send_getCooperationNoConfigInfo( $vendorId, $cooperationNo, $vendorCode){
	...
	public function modifyCooperationNoConfig(\com\vip\vop\vendor\ModifyCooperationNoConfigRequired $param){
		...
		$this->send_modifyCooperationNoConfig( $param);
		return $this->recv_modifyCooperationNoConfig();
	}
	
	public function send_modifyCooperationNoConfig(\com\vip\vop\vendor\ModifyCooperationNoConfigRequired $param){
		
		$this->initInvocation("modifyCooperationNoConfig");
		$args = new \com\vip\vop\vendor\VendorWhiteListService_modifyCooperationNoConfig_args();
	...
	public function recv_modifyCooperationNoConfig(){
		
		$result = new \com\vip\vop\vendor\VendorWhiteListService_modifyCooperationNoConfig_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class VendorWhiteListService_modifyCooperationNoConfig_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->param = new \com\vip\vop\vendor\ModifyCooperationNoConfigRequired();
...
class VendorWhiteListService_modifyCooperationNoConfig_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\vop\vendor\ModifyCooperationNoConfigResponse();
			$this->success->read($input);
