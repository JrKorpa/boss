...
class ProductGpdcServiceClient{
	...
	public static function getService(){
		...
		if (! ProductGpdcServiceClient::$isRegis){
			
			ProductGpdcServiceClient::regis ();
			ProductGpdcServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductGpdcServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductGpdcServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\product\gpdc\service\ProductGpdcServiceHelper();
	}
