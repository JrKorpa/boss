...
//    this.TD = this.instance.getCell(this.row, this.col);
    ...
    this.textareaParentStyle.left = editLeft - 1 + 'px';
    ...
    var width = $td.width()+20
      , maxWidth = this.instance.view.maximumVisibleElementWidth(cellLeftOffset)  //10 is TEXTAREAs border and padding
      , height = $td.outerHeight() + 1
      , maxHeight = this.instance.view.maximumVisibleElementHeight(cellTopOffset); //10 is TEXTAREAs border and padding
...
(function (Handsontable) {
  ...
  DateEditor.prototype.showDatepicker = function () {
    ...
    this.datePickerStyle.top = (offset.top + $td.height()) + 16 + 'px';
...
(function (Handsontable) {
  ...
  SelectEditor.prototype.init = function(){
    ...
    //Handsontable.Dom.addClass(this.select, 'select2_category');
...
CopyPasteClass.prototype.init = function () {
  ...
  if (document.getElementById('CopyPasteDiv')) {
    ...
    this.elTextarea = document.createElement('INPUT');
  ...
  this.keydownListener = function (event) {
    ...
    if (isCtrlDown) {
      if (document.activeElement !== that.elTextarea && (that.getSelectionText() != '' || ['INPUT', 'SELECT'].indexOf(document.activeElement.nodeName) != -1)) {
