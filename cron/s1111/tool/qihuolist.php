...
<div class="page">
    ...
    <div class="line">
    	<form action="./qihuolist.php" method="post" enctype="multipart/form-data">
        产品线类型:
        <select name="producttype">
        	<option value="h">黄金饰品</option>
            <option value="b">铂金</option>
            <option value="k">k金</option>
            <option value="d">单钻</option>
            <option value="q">群钻</option>
        </select>&nbsp;&nbsp;
    ...
    <table>
        ...
        <?php
			$data = $orderclass->getallokqihuolist($where);
...
HTML;
		...
		<tr>
        	<td colspan="4" align="center">
				<a href="importokqihuo.php?data=$importstr" target="_blank">
					直接导出信息
				</a>
			</td>
        </tr>
HTML;
				...
				echo <<< HTML
				<tr>
					<td colspan="4" align="center">没有找到数据哟</td>
				<tr>
HTML;
			}
		?>
