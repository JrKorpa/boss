...
final class KELA_API_DB
{
    ...
    /**
     * We know that you can't see the final raw SQL before its parsed by the DB, 
     * but if you want to simulate the final result, this may help.
     * @param  [type] $query  [SQL语句]
     * @param  [type] $params [参数数组]
     * @return [string]       [最终SQL语句]
     */
