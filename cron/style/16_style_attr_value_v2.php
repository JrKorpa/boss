...
//v2数据是否群镶和最大改圈和v3的数据值对不上
//v2 的是否围钻=是否群镶：v2：是：群镶有主钻，否：主钻
// v2  $CNF_GAIQUAN_FANWEI = array("1" => "不支持", "2" => "1个手寸", "3" => "2个手寸", "4" => "3个手寸");  ？？？
//是否关系:1为是,未空代表不带

$is_mark_arr1 = array('is_weizuan','zhua_daizuan','bi_daizuan');
$is_mark_arr0 = array('is_gaiquan','is_kezi');
...
$is_weizuan_arr = array("主钻"=>0,"群镶有主钻"=>1);
...
$style_gaiquan_arr = array("不可改圈"=>0,"不可改圈"=>1,"可增减1个手寸"=>2,"可增减2个手寸"=>3);
...
$kezuo_yanse_arr = array("白色"=>1,"黄色"=>2,"红色"=>3,"分色"=>4);
...
//var_dump($old_attr_value_arr[7],$old_attr_value_arr[27],$old_attr_value_arr[21],$old_attr_value_arr[17]);
//4、获取旧数据的各种属性值
