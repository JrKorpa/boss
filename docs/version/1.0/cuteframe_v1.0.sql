...
--
-- Host: 127.0.0.1
-- Generation Time: 2014-12-31 18:37:33
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.11
...
CREATE TABLE IF NOT EXISTS `rel_menu_button` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='菜单分配按钮相关表' AUTO_INCREMENT=176 ;
...
INSERT INTO `sessions` (`sesskey`, `expiry`, `userid`, `adminid`, `ip`, `data`) VALUES
('caaddcd675ddf768811eae97711537e7', 1420022203, 0, 0, '127.0.0.1', 'a:6:{s:8:"admin_id";s:1:"2";s:10:"admin_name";s:9:"yangfuyou";s:6:"userId";s:1:"2";s:8:"userName";s:9:"yangfuyou";s:8:"realName";s:9:"杨福友";s:8:"userType";s:1:"2";}');
...
CREATE TABLE IF NOT EXISTS `system_access_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统访问日志' AUTO_INCREMENT=12 ;
...
CREATE TABLE IF NOT EXISTS `user_button_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户按钮权限表' AUTO_INCREMENT=30 ;
...
CREATE TABLE IF NOT EXISTS `user_menu_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户菜单权限表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `user_operation_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户操作权限表' AUTO_INCREMENT=47 ;
