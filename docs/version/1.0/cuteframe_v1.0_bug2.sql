...
--
-- Host: 192.168.1.63
-- Generation Time: 2015-01-06 10:45:50
-- 服务器版本： 5.6.22-log
-- PHP Version: 5.5.11
...
CREATE TABLE IF NOT EXISTS `control` (
  ...
  `is_system` tinyint(4) NOT NULL DEFAULT '0' COMMENT '系统内置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文件表' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统菜单表' AUTO_INCREMENT=28 ;
...
(27, 26, 217, '数据配置', 'CONF_ITEM', 'index.php?mod=management&con=ConfItem&act=index', 19, 1, 1, 1420511567, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `operation` (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='操作表' AUTO_INCREMENT=218 ;
...
CREATE TABLE IF NOT EXISTS `permission` (
  ...
  `is_system` tinyint(4) NOT NULL DEFAULT '0' COMMENT '系统内置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='权限表' AUTO_INCREMENT=350 ;
...
CREATE TABLE IF NOT EXISTS `system_access_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统访问日志' AUTO_INCREMENT=68 ;
...
(62, 1420438014, 2, '', 4, '127.0.0.1'),
(63, 1420443331, 1, '', 4, '127.0.0.1'),
(64, 1420511318, 1, '', 4, '127.0.0.1'),
(65, 1420511790, 2, '', 4, '127.0.0.1'),
(66, 1420511846, 2, '', 5, '127.0.0.1'),
(67, 1420511855, 1, '', 4, '127.0.0.1');
