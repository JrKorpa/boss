...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-01-10 18:47:12
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.11
...
CREATE TABLE IF NOT EXISTS `application` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='项目模块表' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `button` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='按钮表' AUTO_INCREMENT=99 ;
...
(92, '下载文档', 5, 17, 'getDoc', 14, 'index.php?mod=management&con=ConfItem&act=getDoc', '下载—配置文件', 0, 0, '查看', 1, 26, 218, 1420216834),
(93, '添加', 1, 6, '', 1, 'index.php?mod=management&con=ConfItem&act=add', '添加-配置项目', 0, 0, '', 1, 26, 219, 1420217410),
(94, '编辑', 2, 7, '', 2, 'index.php?mod=management&con=ConfItem&act=edit', '编辑-配置项目', 0, 0, '', 1, 26, 220, 1420217450),
(95, '删除', 3, 8, '', 3, 'index.php?mod=management&con=ConfItem&act=delete', '删除-配置项目', 0, 0, '', 1, 26, 221, 1420217480),
(96, '增加', 1, 6, '', 1, 'index.php?mod=management&con=Express&act=add', '增加-快递公司', 0, 0, '', 1, 28, 224, 6),
(97, '编辑', 2, 7, '', 2, 'index.php?mod=management&con=Express&act=edit', '编辑-快递公司', 0, 0, '', 1, 28, 225, 5),
(98, '删除', 3, 8, '', 3, 'index.php?mod=management&con=Express&act=delete', '删除-快递公司', 0, 0, '', 1, 28, 226, 4);
...
CREATE TABLE IF NOT EXISTS `control` (
  ...
  `is_system` tinyint(4) NOT NULL DEFAULT '0' COMMENT '系统内置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文件表' AUTO_INCREMENT=29 ;
...
(26, '数据配置', 'ConfItem', 1, 0, 0),
(28, '快递公司', 'Express', 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `express` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='快递公司' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统菜单表' AUTO_INCREMENT=30 ;
...
(16, 24, 184, '组用户管理', 'GROUP_USER', 'index.php?mod=management&con=GroupUser&act=index', 33, 8, 1, 1419821775, 1, 1, 0),
(17, 15, 18, '工作组', 'GROUP', 'index.php?mod=management&con=group&act=index', 5, 3, 1, 92, 1, 1, 0),
(18, 16, 19, '角色管理', 'ROLE', 'index.php?mod=management&con=Role&act=index', 1, 8, 1, 1418812163, 1, 1, 0),
...
(21, 19, 155, '权限管理', 'PERMISSION', 'index.php?mod=management&con=Permission&act=index', 20, 8, 1, 1419043097, 1, 1, 0),
(22, 20, 164, '资源类型', 'RESOURCE_TYPE', 'index.php?mod=management&con=ResourceType&act=index', 23, 8, 1, 1419079055, 1, 1, 0),
(23, 21, 171, '组角色管理', 'GROUP_ROLE', 'index.php?mod=management&con=GroupRole&act=index', 17, 8, 1, 1419217981, 1, 1, 0),
(24, 22, 178, '角色授权', 'ROLE_PERMISSION', 'index.php?mod=management&con=RolePermission&act=index', 32, 8, 1, 1419299580, 1, 1, 0),
(25, 23, 183, '角色用户', 'ROLE_USER', 'index.php?mod=management&con=RoleUser&act=index', 30, 8, 1, 1419301219, 1, 1, 0),
(26, 25, 185, '用户授权', 'USER_PERMISSION', 'index.php?mod=management&con=UserPermission&act=index', 29, 8, 1, 1419491411, 1, 1, 0),
(27, 26, 217, '数据配置', 'CONF_ITEM', 'index.php?mod=management&con=ConfItem&act=index', 98, 1, 1, 1420198230, 1, 0, 0),
(29, 28, 223, '快递公司', 'EXPRESS', 'index.php?mod=management&con=Express&act=index', 253, 7, 1, 1420619111, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `menu_group` (
  ...
  `is_system` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否系统内置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='菜单分组表' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `operation` (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='操作表' AUTO_INCREMENT=227 ;
...
(217, 'index', '默认页-数据配置', 26, 0, 0),
(218, 'getDoc', '下载-配置文件', 26, 0, 0),
(219, 'add', '添加-配置项目', 26, 0, 0),
(220, 'edit', '编辑-配置项目', 26, 0, 0),
(221, 'delete', '删除-配置项目', 26, 0, 0),
(222, 'index', '默认-测试留言', 27, 0, 0),
(223, 'index', '默认页-快递', 28, 0, 0),
(224, 'add', '添加-快递公司', 28, 0, 0),
(225, 'edit', '编辑-快递公司', 28, 0, 0),
(226, 'delete', '删除-快递公司', 28, 0, 0);
...
CREATE TABLE IF NOT EXISTS `permission` (
  ...
  `is_system` tinyint(4) NOT NULL DEFAULT '0' COMMENT '系统内置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='权限表' AUTO_INCREMENT=370 ;
...
(347, 4, 26, '数据配置-数据权限', 'OBJ_CONF_ITEM', '', 0, 0),
(348, 3, 217, '数据配置-默认页-数据配置-操作权限', 'CONF_ITEM_INDEX_O', '', 0, 0),
(349, 1, 27, '数据配置-菜单权限', 'CONF_ITEM_M', '', 0, 0),
(350, 2, 92, '数据配置-下载文档-按钮权限', 'BUTTON92', '', 0, 0),
(351, 3, 218, '数据配置-下载-配置文件-操作权限', 'CONF_ITEM_GET_DOC_O', '', 0, 0),
(352, 3, 219, '数据配置-添加-配置项目-操作权限', 'CONF_ITEM_ADD_O', '', 0, 0),
(353, 3, 220, '数据配置-编辑-配置项目-操作权限', 'CONF_ITEM_EDIT_O', '', 0, 0),
(354, 3, 221, '数据配置-删除-配置项目-操作权限', 'CONF_ITEM_DELETE_O', '', 0, 0),
(355, 2, 93, '数据配置-添加-按钮权限', 'BUTTON93', '', 0, 0),
(356, 2, 94, '数据配置-编辑-按钮权限', 'BUTTON94', '', 0, 0),
(357, 2, 95, '数据配置-删除-按钮权限', 'BUTTON95', '', 0, 0),
(361, 4, 28, '快递公司-数据权限', 'OBJ_EXPRESS', '', 0, 0),
(362, 3, 223, '快递公司-默认页-快递-操作权限', 'EXPRESS_INDEX_O', '', 0, 0),
(363, 1, 29, '快递公司-菜单权限', 'EXPRESS_M', '', 0, 0),
(364, 3, 224, '快递公司-添加-快递公司-操作权限', 'EXPRESS_ADD_O', '', 0, 0),
(365, 3, 225, '快递公司-编辑-快递公司-操作权限', 'EXPRESS_EDIT_O', '', 0, 0),
(366, 3, 226, '快递公司-删除-快递公司-操作权限', 'EXPRESS_DELETE_O', '', 0, 0),
(367, 2, 96, '快递公司-增加-按钮权限', 'BUTTON96', '', 0, 0),
(368, 2, 97, '快递公司-编辑-按钮权限', 'BUTTON97', '', 0, 0),
(369, 2, 98, '快递公司-删除-按钮权限', 'BUTTON98', '', 0, 0);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `rel_menu_button` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='菜单分配按钮相关表' AUTO_INCREMENT=198 ;
...
CREATE TABLE IF NOT EXISTS `role_menu_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色权限表' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `role_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色用户表' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `sales_channels` (
  ...
  `channel_sn` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '渠道编码',
  ...
  `dep_id` int(8) unsigned DEFAULT '0' COMMENT '部门',
  `area_id` int(8) unsigned DEFAULT '0' COMMENT '区域ID',
  `com_id` int(8) unsigned DEFAULT '0' COMMENT '公司ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='销售渠道表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `system_access_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统访问日志' AUTO_INCREMENT=37 ;
...
(12, 1420022792, 1, '', 4, '127.0.0.1'),
(13, 1420198020, 1, '', 4, '127.0.0.1'),
(14, 1420259133, 1, '', 4, '127.0.0.1'),
(15, 1420260591, 1, '', 4, '127.0.0.1'),
(16, 1420335635, 1, '', 4, '127.0.0.1'),
(17, 1420338359, 1, '', 4, '127.0.0.1'),
(18, 1420340820, 1, '', 5, '127.0.0.1'),
(19, 1420340832, 2, '', 4, '127.0.0.1'),
(20, 1420340861, 2, '', 5, '127.0.0.1'),
(21, 1420340868, 1, '', 4, '127.0.0.1'),
(22, 1420347282, 1, '', 4, '127.0.0.1'),
(23, 1420354314, 1, '', 4, '127.0.0.1'),
(24, 1420356585, 1, '', 4, '127.0.0.1'),
(25, 1420357163, 1, '', 4, '127.0.0.1'),
(26, 1420373835, 1, '', 4, '127.0.0.1'),
(27, 1420421935, 1, '', 4, '127.0.0.1'),
(28, 1420509080, 1, '', 4, '127.0.0.1'),
(29, 1420517073, 1, '', 5, '127.0.0.1'),
(30, 1420517084, 2, '', 4, '127.0.0.1'),
(31, 1420517099, 2, '', 5, '127.0.0.1'),
(32, 1420517110, 1, '', 4, '127.0.0.1'),
(33, 1420602477, 1, '', 4, '127.0.0.1'),
(34, 1420678569, 1, '', 4, '127.0.0.1'),
(35, 1420683359, 1, '', 4, '127.0.0.1'),
(36, 1420683703, 1, '', 4, '127.0.0.1');
...
(3, 'zhangsan', 'jAMr18IgSqRF5ldY4QoJF5clwN5NhZlz', '10002', '测试', 1, 0, 0, '2015-01-01', '13812345678', '13812345678', '12345678', 'zhangsan@kela.cn', '', '2015-01-01', 3, 0, NULL, 0, 0);
...
CREATE TABLE IF NOT EXISTS `user_button_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户按钮权限表' AUTO_INCREMENT=56 ;
...
CREATE TABLE IF NOT EXISTS `user_menu_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户菜单权限表' AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `user_operation_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户操作权限表' AUTO_INCREMENT=93 ;
